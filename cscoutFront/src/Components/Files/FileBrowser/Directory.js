    ...
    render() {
        return (
            <div>
                {
                    this.state.loaded ?
                        <ul className='project' style={{
                            listStyleType: "none",
                            listStylePosition: "inside"
                        }}>
                            <li onClick={this.changeExpand} style={{
                                cursor: 'pointer',
                                margin: '10px', textAlign: 'left'
                            }}
                                onMouseEnter={this.changeHoverState} onMouseLeave={
                                    this.changeHoverState}>
                                <img src={this.state.expand ? openFolder : folder} alt='-' />
                                {this.state.name}
                            </li>
                            {this.state.expand ?
                                <li>
